...
- Tests: `node --experimental-strip-types --test tests/model.test.mjs tests/workflow.test.mjs tests/recording.test.mjs tests/ball.test.mjs` and local-only `node tests/api.test.mjs`.
